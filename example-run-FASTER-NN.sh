...
./RAiSD-AI -n FASTER-NN-PT-BINFRQPOS-SCAN-NEUTRAL -mdl RAiSD_Model.FASTER-NN-PT-BINFRQPOS -f -op SWP-SCN -I $TEST_NEUTRAL -L 100000 -frm -G 100 -pci 1 1 -O -k 0.05 
...
# Scan dataset
./RAiSD-AI -n FASTER-NN-PT-BINFRQPOS-SCAN-SWEEP -mdl RAiSD_Model.FASTER-NN-PT-BINFRQPOS -f -op SWP-SCN -I $TEST_SWEEP -L 100000 -frm -T 50000 -d 1000 -G 100 -pci 1 1 -O -l 2 mu=$fprThresholdMU pcl0=$fprThresholdPCL0 
